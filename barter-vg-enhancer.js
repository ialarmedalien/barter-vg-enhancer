...
(function () {
    ...
    (function (module) {
        ...
        })(typeof window !== 'undefined' ? window : commonjsGlobal, (window, noGlobal) => {
            const arr = [];
            ...
            const Sizzle =
                ...
                (function (window) {
                    ...
                    setDocument = Sizzle.setDocument = function (node) {
                        ...
                        support.cssSupportsSelector = assert(() => {
                ...
                if (!xml || parserErrorElem) {
                    jQuery.error(
                        'Invalid XML: ' +
                            (parserErrorElem
                                ? jQuery
                                    .map(parserErrorElem.childNodes, (el) => {
    ...
    class Fractions {
        static getFractions(ratio) {
            ...
            if (digits > 1) {
                rounded =
                    Math.round(smallestFraction.d / Math.pow(10, digits)) * Math.pow(10, digits);
            } else {
    ...
    function addGameDetails(gameOffers) {
        gameOffers.forEach((gameOffer) => {
            ...
            if (tradeRatio < 1) {
                fractions = Fractions.getFractions(tradeRatio);
                fractions.rounded.n + ' : ' + fractions.rounded.d;
                fractions.real.n + ' : ' + fractions.real.d;
                tradeRatioSmallest = fractions.smallest.n + ' : ' + fractions.smallest.d;
            } else if (tradeRatio > 1) {
                fractions = Fractions.getFractions(1 / tradeRatio);
                fractions.rounded.d + ' : ' + fractions.rounded.n;
                fractions.real.d + ' : ' + fractions.real.n;
                tradeRatioSmallest = fractions.smallest.d + ' : ' + fractions.smallest.n;
            } else {
                tradeRatioSmallest = '1 : 1';
            }
            ...
            const steamStorePriceElement = $(gameElement).find(
                '.bve-game-details__steam-store-price'
            );
    ...
    const controllers = [OffersPageController];
